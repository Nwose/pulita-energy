...
import pulitaIcon from "../assets/logo.png";
...
const Header = () => {
  ...
  return (
    <header className="w-full bg-white bg-opacity-95 backdrop-blur-sm sticky top-0 z-50 mb-12">
          ...
          <div className="flex items-center space-x-2 ">
            <Link href="/">
              <Image
                ...
                width={pulitaIcon.width || 40}
                height={pulitaIcon.height || 40}
              />
            </Link>
          </div>
