...
const ScrollRevealCard = () => {
  return (
    <section className="bg-[#efeded] py-20 px-4 sm:px-6 lg:px-8 font-satoshi">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-6 max-h-[600px] overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
            {features.map((feature, index) => (
              <motion.div
                key={index}
                className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-lg transition-all duration-300 transform hover:scale-[1.02] sticky border border-gray-300"
